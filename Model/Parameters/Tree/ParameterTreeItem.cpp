...
QString ParameterTreeItem::fullName() const
{
	QStringList path;
	const ParameterTreeItem* currentItem = this;
	while (currentItem && currentItem->type() != ItemType::Root)
	{
		path.prepend(currentItem->label());
